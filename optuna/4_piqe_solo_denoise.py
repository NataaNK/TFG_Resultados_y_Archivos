...
OUTPUT_FOLDER = "H:/MasOrange/IMAGENES/AAOptimizacion/SalidasConTexto100/5_piqe_optuna_registro_ConTexto100/salidas_optuna_contexto100"         # Carpeta donde se guardan los resultados temporales
MEJOR_SALIDA = "H:/MasOrange/IMAGENES/AAOptimizacion/SalidasConTexto100/5_piqe_optuna_registro_ConTexto100/mejor_salida_optuna_contexto100"      # Carpeta donde se copia la mejor imagen de cada entrada
...
if __name__ == '__main__':
    ...
    # Obtener la lista de imágenes en INPUT_FOLDER (filtrando extensiones válidas)
    ...
    for filename in input_files:
        ...
        # Si ya existe una imagen con este base_name en MEJOR_SALIDA, se omite la optimización
        ...
        # Crear un estudio de Optuna para la imagen actual, optimizando solo denoise_strength
