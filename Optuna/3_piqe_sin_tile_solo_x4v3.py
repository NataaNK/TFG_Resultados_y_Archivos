...
INPUT_FOLDER = "H:/MasOrange/IMAGENES/AAOptimizacion/Final150/seleccion"       # Carpeta de entrada con imágenes
OUTPUT_FOLDER = "H:/MasOrange/IMAGENES/AAOptimizacion/3_piqe_sin_tile_solo_x4v3/salidas_100_trials_misma_img"         # Carpeta donde se guardan los resultados temporales
MEJOR_SALIDA = "H:/MasOrange/IMAGENES/AAOptimizacion/3_piqe_sin_tile_solo_x4v3/mejor_salida_100_trials_misma_img"     # Carpeta donde se copia la mejor imagen de cada entrada
...
def objective(trial):
    ...
    # Fijamos el modelo a "realesr-general-x4v3" sin optimización
    ...
    if trial.number == 0:
        # Aunque ya está fijado el modelo, se reasegura:
        model_name = "realesr-general-x4v3"
