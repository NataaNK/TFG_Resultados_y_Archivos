...
# Para guardar las imágenes: pip install kaleido scikit-learn plotly
...
INPUT_FOLDER = "H:/MasOrange/IMAGENES/AAOptimizacion/Final150/Final150Resized"       # Carpeta de entrada con imágenes
OUTPUT_FOLDER = "H:/MasOrange/IMAGENES/AAOptimizacion/2_piqe_sin_tile/salidas_resized_piqe"         # Carpeta donde se guardan los resultados temporales
MEJOR_SALIDA = "H:/MasOrange/IMAGENES/AAOptimizacion/2_piqe_sin_tile/mejor_salida_resized_piqe"     # Carpeta donde se copia la mejor imagen de cada entrada
...
def objective(trial):
    ...
    # Se fija el parámetro tile a 0, sin optimizarlo:
    tile = 0
    ...
    try:
        ...
        # Retornar un valor alto para penalizar el trial
        score = 1e6
...
if __name__ == '__main__':
    ...
    for filename in input_files:
        ...
        base_name, _ = os.path.splitext(os.path.basename(CURRENT_INPUT_IMAGE))
        ...
        try:
            # Obtener importancias y el parámetro más importante
            ...
            # Crear y guardar gráfico del historial de optimización
            ...
            # Crear y guardar gráfico de importancia de parámetros
            ...
            # Crear y guardar gráficos slice para cada parámetro
