%% Comparación de resultados: CON Filtros vs SIN Filtros
...
times_sec_CON = [134.92+528.97, 134.92+179.48, 134.92+704.81, 134.92+237.96, 134.92+17.73, 134.92+690.50];
...
legend('CON Filtros', 'SIN Filtros');
grid on;

%% Procesamiento de métricas para CON Filtros
% Rutas para CON Filtros
subdataset_template_CON = {...
    'C:\Users\nekos\OneDrive\Escritorio\Filtros\DRTC_final150_filtros\Final150Compressed'};
ref_dirs_CON = {...
...
%% Procesamiento de métricas para SIN Filtros
% Rutas para SIN Filtros
...
for m = 1:length(metricsList)
    ...
    legend([h_con, h_sin], {'CON Filtros','SIN Filtros'});
