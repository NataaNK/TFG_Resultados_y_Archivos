...
nameX = 'x4v3 OPTUNA';  % Condición X
nameY = 'RealESRGANx4Plus';  % Condición Y

% Definir el nombre del modelo (único) a comparar, por ejemplo "DRTC"
...
subdataset_template_X = {...
    "C:\Users\nekos\OneDrive\Escritorio\AAOptimizacion\4_piqe_solo_denoise\Final150_solo_denoise_25_trials\mejor_salida_25_final150_compressed"};
ref_dirs_X = {...
    "C:\Users\nekos\OneDrive\Escritorio\AAOptimizacion\Final150\Final150Original"};
...
% RealESRGAN antes:
% subdataset_template_X = {...
%     'C:\Users\nekos\OneDrive\Escritorio\resultados_subdataset\resultados_subdataset\RealESRGAN\COLOR\RealESRGAN_BlancoNegroCompressed'
%     'C:\Users\nekos\OneDrive\Escritorio\resultados_subdataset\resultados_subdataset\RealESRGAN\COLOR\RealESRGAN_ColorCompressed'
%     'C:\Users\nekos\OneDrive\Escritorio\resultados_subdataset\resultados_subdataset\RealESRGAN\COLOR\RealESRGAN_SepiaCompressed'};
% ref_dirs_X = {...
...
for sub_idx = 1:length(subdataset_template_Y)
    ...
    for i = 1:length(file_list)
        ...
        % Buscar imagen de referencia (sin lógica de palabra clave)
...
for m = 1:length(metricsList)
    ...
    ylabel(yLabelText, 'FontSize', 12, 'Interpreter', 'none');
    ...
    title(sprintf('Comparación de %s (%s vs %s)', metricTitle, nameX, nameY), 'FontSize', 14, 'Interpreter', 'none');
    xticks(1);
