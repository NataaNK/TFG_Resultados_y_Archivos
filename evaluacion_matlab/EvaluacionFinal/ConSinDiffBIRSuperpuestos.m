%% Comparación de resultados: CON DiffBIR vs SIN DiffBIR
...
times_sec_CON = [216.62+535.21, 216.62+181.82, 216.62+698.03, 216.62+226.14, 216.62+29.70, 216.62+681.35];
...
legend('CON DiffBIR', 'SIN DiffBIR');
grid on;

%% Procesamiento de métricas para CON DiffBIR
% Rutas para CON DiffBIR
subdataset_template_CON = {...
    'C:\Users\nekos\OneDrive\Escritorio\DiffBIR\DRTC_final150_diff\Final150Compressed'};
ref_dirs_CON = {...
...
%% Procesamiento de métricas para SIN DiffBIR
% Rutas para SIN DiffBIR
...
for m = 1:length(metricsList)
    ...
    legend([h_con, h_sin], {'CON DiffBIR','SIN DiffBIR'});
