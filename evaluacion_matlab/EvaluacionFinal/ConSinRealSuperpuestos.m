%% Comparación de resultados: CON RealESRGAN vs SIN RealESRGAN
...
times_sec_CON = [129.84+572.87, 129.84+228.18, 129.84+726.01, 129.84+298.38, 129.84+50.44, 129.84+732.42];
times_sec_SIN = [619.42, 282.73, 770.41, 285.36, 24.20, 772.52];
...
legend('CON RealESRGAN', 'SIN RealESRGAN');
grid on;

%% Procesamiento de métricas para CON RealESRGAN
% Rutas para CON RealESRGAN
subdataset_template_CON = {...
    'C:\Users\nekos\OneDrive\Escritorio\Real_scale1\DRTC_final150_real\Final150Compressed'};
ref_dirs_CON = {...
    'C:\Users\nekos\OneDrive\Escritorio\DiffBIR\Final150\Final150Original'};
...
%% Procesamiento de métricas para SIN RealESRGAN
% Rutas para SIN RealESRGAN
...
for m = 1:length(metricsList)
    ...
    legend([h_con, h_sin], {'CON RealESRGAN','SIN RealESRGAN'});
