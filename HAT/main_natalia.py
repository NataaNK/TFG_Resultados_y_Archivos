...
def update_yaml(input_dir, yaml_path):
    ...
    if 'datasets' in config and 'test_1' in config['datasets']:
        config['datasets']['test_1']['dataroot_lq'] = input_dir
...
def main():
    parser = argparse.ArgumentParser(description="Ejecutar HAT con ruta dinámica para input_dir.")
    parser.add_argument(
        "--input_dir",
        type=str,
        required=True,
    ...
    parser.add_argument(
        "--yaml_path",
        type=str,
        default="options/test/NATALIA_x4.yml",
